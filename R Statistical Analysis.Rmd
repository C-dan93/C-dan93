...
summary(lm_model)
```
The scatter plot points (blue tiny circles) show the linear relationship between 
LBM and BMI.
• Most of the observed points (blue tiny circles) fall within the interval lines 
(green lines), this is a positive indication of the model’s reliability. 
• The narrow confidence intervals (orange lines) indicate that the model 
operates with a lower uncertainty, and this is good for predictive purposes.
• The positive correlation in the graph shows implies that as LBM increases, 
BMI increases. This in no way implies direct causation, though there is such a 
possibility.
